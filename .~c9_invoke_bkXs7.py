...
def stats_grabber(crawled_feed):
    ...
    #same for title
    max_pos = crawled_feed.nlargest(1,'Title Score')
    max_pos['Title'] = textwrap.shorten(str(max_pos['Title']),width=100)
    max_neg = crawled_feed.nsmallest(1,'Title Score')
    max_neg['Title'] = textwrap.shorten(str(max_neg['Title']),width=100)
