...
function addMarker(place)
{
    ...
    marker.addListener('click',function() {
        ...
        $.getJSON(Flask.url_for("articles"), param )
        //promise
        .done(function(data, textStatus, jqXHR) {
            ...
            else
            {
                ...
                for (var i = 0; i <data.length; i++){
                    ...
                    contentstring += "<li><a href='" + data[i].link  +  "'/>"+ data[i].title + "</li>";
                }

                contentstring += "</ul>";

                //how to set info window
...
function removeMarkers()
{
    ...
    for (var x = 0, m = markers.length; x < m; x++)
    {
